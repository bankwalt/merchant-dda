...
export function DisclosureSheet({ open, title, file, onClose, onAccept, alreadyAccepted }) {
      ...
      <div className="sheet">
        ...
        <div className="sheet-header">
          <div className="sheet-title">
            <div className="body-200 muted-strong" style={{ textTransform: 'uppercase', letterSpacing: '0.06em' }}>
              First Internet Bank
            </div>
