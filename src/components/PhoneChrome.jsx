  ...
  if (kind === 'wifi') {
    return (
      <svg width="16" height="12" viewBox="0 0 16 12" fill="none" aria-hidden="true">
        ...
        <path d="M3.5 6.5a6 6 0 019 0" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
        <path d="M1 4a9 9 0 0114 0" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      </svg>
    )
  }
  return (
