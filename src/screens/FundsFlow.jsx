...
import { initialMerchant as merchant } from '../data/merchant.js'

const CADENCE_LABEL = { daily: 'daily', weekly: 'weekly', monthly: 'monthly' }

export function FundsFlow({ onBack, onActivate }) {
  const [savings, setSavings] = useState({ enabled: false, amount: 200, cadence: 'monthly' })
    ...
    <div className="screen">
      ...
      <div className="screen-body stack-lg">
        <div>
          ...
          <p className="body-400 muted" style={{ margin: '6px 0 0' }}>
            Starting today, every card settlement sweeps into your new
            Partner Business Anywhere account.
          </p>
        </div>
        ...
        <div className="flow-card">
          ...
          <div className="flow-branch">
            ...
            <div className="flow-node tone-muted is-compact is-strike" aria-label="Chase legacy route">
              <div className="flow-node-icon">
        ...
        <div className="notice">
          ...
          <span className="body-200" style={{ color: 'rgb(var(--info-800))' }}>
            Chase is no longer in the settlement loop — all card sales now land
            in your Partner account. You can still send on-demand transfers
            from Settings.
          </span>
        </div>
      </div>
      ...
      <div className="screen-footer">
        ...
        <p className="legal-text muted" style={{ textAlign: 'center', margin: '12px 0 0' }}>
          By activating, you authorize <strong>First Internet Bank</strong> to
          open a Demand Deposit Account in your business's name, and you agree
          to the disclosures reviewed above.
        </p>
      </div>
...
function SavingsSummary({ savings, monthly, onEdit, onEnable }) {
  if (!savings.enabled) {
    return (
...
function FlowNode({ icon, label, sub, tone = 'neutral', emphasis, compact, strikethrough }) {
  return (
    <div
